...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
            <a class="nav-link font-weight-bold text-white-80" href="dashboard_admin.php">
            ...
            <hr class="sidebar-divider my-0">
            <li class="nav-item">
                <a class="nav-link font-weight-bold text-white-80" href="data_hari_ini.php">
                    <span>Data Hari Ini (admin)</span></a>
            </li>
            <hr class="sidebar-divider my-0">
            <li class="nav-item">
                <a class="nav-link font-weight-bold text-white-80" href="rekapitulasi_penelusuran.php">
                    <span>Rekapitulasi & Penulusuran (admin)</span></a>
            </li>
            <hr class="sidebar-divider my-0">
            <li class="nav-item font-weight-bold text-white-80">
                <a class="nav-link" href="akun_terdaftar.php">
                    <span>Akun Terdaftar (admin)</span></a>
            </li>
            <!-- Footer -->
            <hr class="sidebar-divider my-0">
            <div class="foot">
